...
# This launcher is shared by the MESI bring-up path and the early MOESI
# cold-bring-up path. Protocol-specific restore plumbing still lives in the
# Ruby protocol code itself.
